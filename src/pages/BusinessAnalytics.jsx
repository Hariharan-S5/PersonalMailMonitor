  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in" style={{ animationDelay: '200ms' }}>
        <StatCard title="Total Revenue" value={`₹${revenue.toLocaleString(undefined, { maximumFractionDigits: 0 })}`} icon={DollarSign} color="bg-emerald-500" delay={200} isLoading={isLoading} />
        <StatCard title="Total Orders" value={orders} icon={ShoppingCart} color="bg-indigo-500" delay={300} isLoading={isLoading} />
        <StatCard title="Active Customers" value={activeCustomers} icon={Users} color="bg-blue-500" delay={400} isLoading={isLoading} />
        <StatCard title="New Customers" value={newCustomers} icon={UserPlus} color="bg-sky-500" delay={500} isLoading={isLoading} />
        <StatCard title="Completed Sales" value={completedSales} icon={CheckCircle} color="bg-teal-500" delay={600} isLoading={isLoading} />
        <StatCard title="Pending Orders" value={pendingOrders} icon={Clock} color="bg-amber-500" delay={700} isLoading={isLoading} />
        <StatCard title="Canceled Orders" value={canceledOrders} icon={XCircle} color="bg-red-500" delay={800} isLoading={isLoading} />
        <StatCard title="Conversion Rate" value={`${conversionRate}%`} icon={Percent} color="bg-purple-500" delay={900} isLoading={isLoading} />
      </div>
