                  ...
                  >
                    ...
                    <div className="px-6 flex items-center gap-4">
                      {currentAccount?.id !== account.id ? (
                        ...
                        <div className="flex items-center gap-1.5 px-4 py-2 bg-emerald-50 text-emerald-600 rounded-2xl font-bold text-[10px] uppercase tracking-[0.15em] border border-emerald-100 shadow-sm transition-all duration-300">
                           <div className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
                          </div>
