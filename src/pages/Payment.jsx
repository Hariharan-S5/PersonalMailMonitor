                ...
                <div className="mt-4">
                  <button
                    ...
                    className={`w-full py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-3 shadow-xl ${
                        loading ? 'bg-indigo-900 text-indigo-300 opacity-60' : 'bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:scale-[1.02] active:scale-95 shadow-indigo-500/25'
                    }`}
                  >
                     {loading ? <PremiumSpinner size={14} /> : <>Subscribe Securely <ArrowRight size={16} /></>}
                  </button>
                </div>
