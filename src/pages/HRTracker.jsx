  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in" style={{ animationDelay: '200ms' }}>
        <StatCard title="Open Postings" value={postingsCount} icon={Briefcase} color="bg-indigo-500" delay={200} isLoading={isLoading} />
        <StatCard title="Total Applied" value={appliedCount} icon={Users} color="bg-blue-500" delay={300} isLoading={isLoading} />
        <StatCard title="Shortlisted" value={shortlistedCount} icon={ClipboardCheck} color="bg-amber-500" delay={400} isLoading={isLoading} />
        <StatCard title="Interviews" value={interviewsCount} icon={Calendar} color="bg-purple-500" delay={500} isLoading={isLoading} />
        <StatCard title="Offers Sent" value={offersCount} icon={FileText} color="bg-pink-500" delay={600} isLoading={isLoading} />
        <StatCard title="Offers Accepted" value={offersAcceptedCount} icon={Award} color="bg-emerald-500" delay={700} isLoading={isLoading} />
        <StatCard title="Rejected" value={rejectedCount} icon={XCircle} color="bg-red-500" delay={800} isLoading={isLoading} />
        <StatCard title="Success Rate" value={`${appliedCount > 0 ? Math.round((offersAcceptedCount / appliedCount) * 100) : 0}%`} icon={TrendingUp} color="bg-sky-500" delay={900} isLoading={isLoading} />
      </div>
