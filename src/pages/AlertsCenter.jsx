...
const AlertsCenter = () => {
  const { getStats, isLoading, fetchEmails } = useEmailStore();
  ...
  return (
    <div className="space-y-10 max-w-7xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 animate-fade-in" style={{ animationDelay: '200ms' }}>
        <StatCard title="Total Alerts" value={total} icon={Bell} color="bg-indigo-500" delay={200} isLoading={isLoading} />
        <StatCard title="Critical" value={critical} icon={ShieldAlert} color="bg-red-500" delay={300} isLoading={isLoading} />
        <StatCard title="Warning" value={warning} icon={AlertTriangle} color="bg-amber-500" delay={400} isLoading={isLoading} />
        <StatCard title="Resolved" value={resolved} icon={CheckCircle} color="bg-emerald-500" delay={500} isLoading={isLoading} />
        <StatCard title="Pending" value={pending} icon={Clock} color="bg-blue-500" delay={600} isLoading={isLoading} />
      </div>
