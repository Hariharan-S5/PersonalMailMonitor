...
const StatCard = ({ title, value, icon: Icon, color, trend, delay, isLoading }) => (
  <div 
  ...
  >
    <div className="flex items-center justify-between relative z-10">
      ...
      {trend && (
        <div className="flex items-center gap-1.5 px-3 py-1 bg-emerald-50 text-emerald-600 rounded-full font-bold text-xs">
          <TrendingUp size={14} />
          {trend}
        </div>
      )}
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    }, 120000); // 2 minute polling like global sync
