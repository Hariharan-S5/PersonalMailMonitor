...
const PersonalCard = ({ icon: Icon, title, value, label, color, delay, trend, isLoading }) => (
  ...
  >
    <div className="flex items-center justify-between relative z-10">
      ...
      {trend && (
        <div className="flex items-center gap-1.5 px-3 py-1 bg-slate-50 text-slate-400 rounded-full font-bold text-[10px] uppercase tracking-widest">
...
const PersonalPage = () => {
  const { getStats, user, fetchEmails, error, isLoading, emails } = useEmailStore();
  ...
  return (
    <div id="personal-dashboard-root" className="space-y-10 max-w-7xl mx-auto pb-10 px-4">
      {/* Header */}
